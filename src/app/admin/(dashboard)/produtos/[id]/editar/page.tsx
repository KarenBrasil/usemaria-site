    ...
    <div className="max-w-3xl mx-auto pb-24">
      ...
      <form action={updateProductWithId} className="flex flex-col gap-8">
        ...
        <section className="bg-white rounded-2xl p-6 md:p-8 shadow-sm border border-zinc-100 flex flex-col gap-6">
          ...
          <div className="relative border-2 border-dashed border-zinc-200 rounded-2xl p-10 hover:bg-zinc-50 hover:border-zinc-400 transition-colors group cursor-pointer flex flex-col items-center justify-center gap-4">
            <input 
              name="imageFile" 
              type="file" 
              accept="image/*"
            ...
            />
            <div className="w-16 h-16 bg-white rounded-full shadow-sm border border-zinc-100 flex items-center justify-center text-zinc-400 group-hover:text-zinc-600 transition-colors">
            ...
            <div className="text-center">
              <p className="text-sm font-medium text-zinc-700">Clique para enviar foto da galeria</p>
              <p className="text-xs text-zinc-400 mt-1">Formatos suportados: JPG, PNG, WEBP</p>
            </div>
          </div>
        </section>

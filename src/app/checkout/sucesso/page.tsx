              ...
              <div className="p-7 sm:p-9">
                ...
                <div className="rounded-xl border border-[#E7DDD1] p-5 text-sm leading-6 text-zinc-600">
                  ...
                  <ol className="mt-2 list-decimal space-y-1 pl-5">
                    <li>Nossa equipe entra em contato para combinar o pagamento (Pix ou cartão) e a entrega.</li>
                    <li>Assim que o pedido for enviado, o código de rastreio aparece na página de acompanhamento.</li>
                  </ol>
                ...
                <div className="mt-7 space-y-3">
                  ...
                  <p className="text-center text-xs text-zinc-500">Opcional — nossa equipe também entra em contato com você.</p>
